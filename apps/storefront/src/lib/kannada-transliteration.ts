...
export const KANNADA_DICTIONARY: { [key: string]: string[] } = {
  ...
  "baa": ["ಬಾ", "ಬನ್ನಿ", "ಬಾರೋ"],
  "vijaya": ["ವಿಜಯ", "ವಿಜಯದ", "ವಿಜಯದಲ್ಲಿ"],
  "kaavya": ["ಕಾವ್ಯ", "ಕಾವ್ಯದ", "ಕಾವ್ಯದಲ್ಲಿ"],
  "dharma": ["ಧರ್ಮ", "ಧರ್ಮದ", "ಧರ್ಮದಲ್ಲಿ"],
  "ratna": ["ರತ್ನ", "ರತ್ನದ", "ರತ್ನದಲ್ಲಿ"],
  "keerti": ["ಕೀರ್ತಿ", "ಕೀರ್ತಿದ", "ಕೀರ್ತಿದಲ್ಲಿ"],
  "bhaavane": ["ಭಾವನೆ", "ಭಾವನೆದ", "ಭಾವನೆದಲ್ಲಿ"],
  "gaurava": ["ಗೌರವ", "ಗೌರವದ", "ಗೌರವದಲ್ಲಿ"],
  "shaanti": ["ಶಾಂತಿ", "ಶಾಂತಿದ", "ಶಾಂತಿದಲ್ಲಿ"],
  "sneeha": ["ಸ್ನೇಹ", "ಸ್ನೇಹದ", "ಸ್ನೇಹದಲ್ಲಿ"],
  "santoosha": ["ಸಂತೋಷ", "ಸಂತೋಷದ", "ಸಂತೋಷದಲ್ಲಿ"],
  "chitra": ["ಚಿತ್ರ", "ಚಿತ್ರದ", "ಚಿತ್ರದಲ್ಲಿ"],
  "bhaashana": ["ಭಾಷಣ", "ಭಾಷಣದ", "ಭಾಷಣದಲ್ಲಿ"],
  "sangeeta": ["ಸಂಗೀತ", "ಸಂಗೀತದ", "ಸಂಗೀತದಲ್ಲಿ"],
  "naatya": ["ನಾಟ್ಯ", "ನಾಟ್ಯದ", "ನಾಟ್ಯದಲ್ಲಿ"],
  "patrike": ["ಪತ್ರಿಕೆ", "ಪತ್ರಿಕೆದ", "ಪತ್ರಿಕೆದಲ್ಲಿ"],
  "looka": ["ಲೋಕ", "ಲೋಕದ", "ಲೋಕದಲ್ಲಿ"],
  "deesha": ["ದೇಶ", "ದೇಶದ", "ದೇಶದಲ್ಲಿ"],
  "graama": ["ಗ್ರಾಮ", "ಗ್ರಾಮದ", "ಗ್ರಾಮದಲ್ಲಿ"],
  "mattu": ["ಮತ್ತು", "ಮತ್ತುದ", "ಮತ್ತುದಲ್ಲಿ"],
  "endu": ["ಎಂದು", "ಎಂದುದ", "ಎಂದುದಲ್ಲಿ"],
  "ondu": ["ಒಂದು", "ಒಂದುದ", "ಒಂದುದಲ್ಲಿ"],
  "naavu": ["ನಾವು", "ನಾವುದ", "ನಾವುದಲ್ಲಿ"],
  "aadare": ["ಆದರೆ", "ಆದರೆದ", "ಆದರೆದಲ್ಲಿ"],
  "maanya": ["ಮಾನ್ಯ", "ಮಾನ್ಯದ", "ಮಾನ್ಯದಲ್ಲಿ"],
  "athavaa": ["ಅಥವಾ", "ಅಥವಾದ", "ಅಥವಾದಲ್ಲಿ"],
  "muktaka": ["ಮುಕ್ತಕ", "ಮುಕ್ತಕದ", "ಮುಕ್ತಕದಲ್ಲಿ"],
  "tanna": ["ತನ್ನ", "ತನ್ನದ", "ತನ್ನದಲ್ಲಿ"],
  "illa": ["ಇಲ್ಲ", "ಇಲ್ಲದ", "ಇಲ್ಲದಲ್ಲಿ"],
  "adannu": ["ಅದನ್ನು", "ಅದನ್ನುದ", "ಅದನ್ನುದಲ್ಲಿ"],
  "haagaagi": ["ಹಾಗಾಗಿ", "ಹಾಗಾಗಿದ", "ಹಾಗಾಗಿದಲ್ಲಿ"],
  "beere": ["ಬೇರೆ", "ಬೇರೆದ", "ಬೇರೆದಲ್ಲಿ"],
  "jagattina": ["ಜಗತ್ತಿನ", "ಜಗತ್ತಿನದ", "ಜಗತ್ತಿನದಲ್ಲಿ"],
  "antaha": ["ಅಂತಹ", "ಅಂತಹದ", "ಅಂತಹದಲ್ಲಿ"],
  "keevala": ["ಕೇವಲ", "ಕೇವಲದ", "ಕೇವಲದಲ್ಲಿ"],
  "meele": ["ಮೇಲೆ", "ಮೇಲೆದ", "ಮೇಲೆದಲ್ಲಿ"],
  "nammannu": ["ನಮ್ಮನ್ನು", "ನಮ್ಮನ್ನುದ", "ನಮ್ಮನ್ನುದಲ್ಲಿ"],
  "manassu": ["ಮನಸ್ಸು", "ಮನಸ್ಸುದ", "ಮನಸ್ಸುದಲ್ಲಿ"],
  "endare": ["ಎಂದರೆ", "ಎಂದರೆದ", "ಎಂದರೆದಲ್ಲಿ"],
  "ennuva": ["ಎನ್ನುವ", "ಎನ್ನುವದ", "ಎನ್ನುವದಲ್ಲಿ"],
  "kagga": ["ಕಗ್ಗ", "ಕಗ್ಗದ", "ಕಗ್ಗದಲ್ಲಿ"],
  "allavee": ["ಅಲ್ಲವೇ", "ಅಲ್ಲವೇದ", "ಅಲ್ಲವೇದಲ್ಲಿ"],
  "paramaatma": ["ಪರಮಾತ್ಮ", "ಪರಮಾತ್ಮದ", "ಪರಮಾತ್ಮದಲ್ಲಿ"],
  "ellavuu": ["ಎಲ್ಲವೂ", "ಎಲ್ಲವೂದ", "ಎಲ್ಲವೂದಲ್ಲಿ"],
  "maatra": ["ಮಾತ್ರ", "ಮಾತ್ರದ", "ಮಾತ್ರದಲ್ಲಿ"],
  "halavaaru": ["ಹಲವಾರು", "ಹಲವಾರುದ", "ಹಲವಾರುದಲ್ಲಿ"],
  "rasadhaare": ["ರಸಧಾರೆ", "ರಸಧಾರೆದ", "ರಸಧಾರೆದಲ್ಲಿ"],
  "haageyee": ["ಹಾಗೆಯೇ", "ಹಾಗೆಯೇದ", "ಹಾಗೆಯೇದಲ್ಲಿ"],
  "illi": ["ಇಲ್ಲಿ", "ಇಲ್ಲಿದ", "ಇಲ್ಲಿದಲ್ಲಿ"],
  "badukina": ["ಬದುಕಿನ", "ಬದುಕಿನದ", "ಬದುಕಿನದಲ್ಲಿ"],
  "maaduva": ["ಮಾಡುವ", "ಮಾಡುವದ", "ಮಾಡುವದಲ್ಲಿ"],
  "jeevana": ["ಜೀವನ", "ಜೀವನದ", "ಜೀವನದಲ್ಲಿ"],
  "prayatna": ["ಪ್ರಯತ್ನ", "ಪ್ರಯತ್ನದ", "ಪ್ರಯತ್ನದಲ್ಲಿ"],
  "ondee": ["ಒಂದೇ", "ಒಂದೇದ", "ಒಂದೇದಲ್ಲಿ"],
  "reetiya": ["ರೀತಿಯ", "ರೀತಿಯದ", "ರೀತಿಯದಲ್ಲಿ"],
  "eekendare": ["ಏಕೆಂದರೆ", "ಏಕೆಂದರೆದ", "ಏಕೆಂದರೆದಲ್ಲಿ"],
  "paramaatmana": ["ಪರಮಾತ್ಮನ", "ಪರಮಾತ್ಮನದ", "ಪರಮಾತ್ಮನದಲ್ಲಿ"],
  "iruttade": ["ಇರುತ್ತದೆ", "ಇರುತ್ತದೆದ", "ಇರುತ್ತದೆದಲ್ಲಿ"],
  "manushya": ["ಮನುಷ್ಯ", "ಮನುಷ್ಯದ", "ಮನುಷ್ಯದಲ್ಲಿ"],
}
